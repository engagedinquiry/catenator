...
APP = reader-app
TARGET_REPO = https://github.com/engagedinquiry/catenator-docs.git
BASE_HREF = /
DIST_SUBFOLDER = dist/reader-app/browser

---

IF TARGET_REPO exists, do following in a new branch.
